...
{   
   ...
   // printf("step into the code file\n");
	  ...
	  for(x=0;x<240;x++)
			...
			*/
			R = ((wPix16 & RGB565_MASK_RED) >> 8) ; ///< 取值范围0-31，线性放大
         	G = ((wPix16 & RGB565_MASK_GREEN) >> 3) ;///< 取值范围0-63，线性放大
         	B = (wPix16 & RGB565_MASK_BLUE)<<3;            ///< 取值范围0-31，线性放大
            ...
            R = (wPix16 & RGB555_MASK_RED) >>7; ///< 取值范围0-31，线性放大
         	G = (wPix16 & RGB555_MASK_GREEN) >> 2;///< 取值范围0-63，线性放大
         	B = (wPix16 & RGB555_MASK_BLUE)<<3;            ///< 取值范围0-31，线性放大
           */ 
            R = (wPix16 & RGB555_MASK_RED) >>8; ///< 取值范围0-31，线性放大
         	G = (wPix16 & RGB555_MASK_GREEN) >> 5;///< 取值范围0-63，线性放大
         	B = (wPix16 & RGB555_MASK_BLUE);            ///< 取值范围0-31，线性放大
