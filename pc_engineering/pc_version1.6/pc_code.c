   ...
   // int R,G,B;
    ...
    printf("step into the code file\n");
	  ...
	  for(x=0;x<240;x++)
            ...
            codebuff[fi]=((((DataBuffer[i]|DataBuffer[i+1]<<8) & B_RGB565_MASK_RED) >>16)|(((DataBuffer[i]|DataBuffer[i+1]<<8) & B_RGB565_MASK_GREEN) <<5)|(((DataBuffer[i]|DataBuffer[i+1]<<8) & B_RGB565_MASK_BLUE)<<19));
			 ...
			 */
             ...
             if(fi==239*319){printf("fi=239*319=%d\n",fi);
			 break;}
