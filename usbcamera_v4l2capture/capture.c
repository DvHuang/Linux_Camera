...
//	unsigned int min;	
	...
	set_fmt.fmt.pix.width        = 10;
	set_fmt.fmt.pix.height       = 20;
	set_fmt.fmt.pix.pixelformat  = V4L2_PIX_FMT_RGB24;
	...
	else
	{
		...
		printf("after set pixelformat = %c\n",fmt.fmt.pix.pixelformat);
